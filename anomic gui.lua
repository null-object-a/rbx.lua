...
----------------------------------------------------------------------------------------------
   local window = library:AddWindow("funny gui", {
   main_color = Color3.fromRGB(29.8, 15.69, 50.98), min_size = Vector2.new(420, 610), toggle_key = Enum.KeyCode.F, can_resize = false,       
   })
   ...
   maintab:AddButton("Picklock printers (must hold a lockpick)",function()
   ...
   maintab:AddButton("Fly", function()
   loadstring(game:HttpGet(('https://pastebin.com/raw/WxmvCLLH'),true))() 
   end)
    maintab:AddButton("Destroy all printers (must hold a baton)", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Shariiii/Anomic-Stuff/main/Baton%20Farm%20Script.lua",true))()
   end)
    maintab:AddButton("Anti spawn cooldown", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Shariiii/Anomic-Stuff/main/Anti%20Spawn%20CD.lua",true))()
   end)
  maintab:AddButton("Always run", function()
   game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 25
 end)


   maintab:AddTextBox("TP to player", function(text)
       hrp.CFrame = game:GetService("Players"):FindFirstChild(text).Character.HumanoidRootPart.CFrame
   end)
